...
// Request interceptor to add shop_id and auth token
api.interceptors.request.use(
    (config) => {
        ...
        // Add static shop token for simplicity (in a real app, this should be env var or secure)
        config.headers['x-shop-token'] = "local-shop-secret-123";
        return config;
    },
    (error) => {
...
export const analyticsService = {
    ...
    getFileTypeDistribution: () => api.get('/analytics/file-type-distribution')
};
