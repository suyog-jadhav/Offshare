...
export const updateShop = asyncHandler(async (req, res) => {
    ...
    const updatedShop = {
        ...
        // Frontend sends 'ssid', 'password', 'auth'
        wifi_ssid: req.body.wifi_ssid ?? req.body.ssid ?? existingShop.wifi_ssid,
        wifi_password: req.body.wifi_password ?? req.body.password ?? existingShop.wifi_password,
        wifi_auth: req.body.wifi_auth ?? req.body.auth ?? existingShop.wifi_auth,
